                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card mb-4 px-3">
                                    <div class="row bg-dark border-radius-xl mt-3 p-3 px-4 mx-2">
                                        <div class="col-12 col-md-6 d-flex justify-content-center justify-content-md-start align-items-center mb-4 mb-md-0">
                                            <h6 class="mb-0 text-white">Tabel Data Produk</h6>
                                        </div>
                                        <div class="col-12 col-md-6 text-center text-md-end">
                                            <a class="btn bg-gradient-success mb-0 w-100 w-md-auto" href="{{ route('produk.create') }}">
                                                Tambah
                                            </a>
                                        </div>
                                    </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex px-2 py-1">
                                                                    <div>
                                                                        <img src="{{ asset('images/produk/'.$item->gambar) }}" class="avatar avatar-sm me-3" alt="{{ $item->nama_produk }}">
                                                                    </div>
                                                            ...
                                                            <td class="align-middle">
                                                                <span class="text-dark text-xs font-weight-bold">Rp. {{ number_format($item->harga_produk, 0, ',','.') }}</span>
                                                            </td>
                                                            <td class="align-middle text-sm text-center">
                                                                @if ($item->status_produk == 'Ada')
                                                            ...
                                                            <td class="align-middle">
                                                                <a href="{{ route('produk.edit', $item->produk_id) }}" class="me-3 text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                                                    Edit
                                                                </a>
                                                                <form action="{{ route('produk.destroy', $item->produk_id) }}" method="POST" class="d-inline" onsubmit="return confirm('Anda yakin ingin menghapus data ini ?')">
                                                                    @method('delete')
                                                                    @csrf
